...
function PostJob() {
  ...
  return (
    ...
    <form id="job_form"  onSubmit={submitFunc}><br/>
        ...
        <div className="input-Box">
          <label className='details'>Job Title</label><input type="text" id="title" name="title"  onChange={handleChange} placeholder="Enter Job Title" required/><br/>
        </div>
        <div className="input-Box">
        ...
        <div className="input-Box">
        <label className='details'>Year of Study</label><input type="number" id="year" name="year"  onChange={handleChange} placeholder="Year of Study" required/><br/>
        </div>
        ...
        <div className="input-Box">
        <label className='details'>Skill Requirements</label><input type="text" id="requirement" name="requirement" size="100" onChange={handleChange} placeholder="Enter Job Requirements" multiple required/><br/>
        </div>
        
        
        <div className="input-Box">
          <label className='details'>Job Description</label><input type="text" id="desc" name="desc"  onChange={handleChange} size="100" placeholder="Enter Job Description" required /><br/>
